...
po/dice-roller.bhdouglass.pot: qml/Main.qml qml/DiceDialog.qml qml/MainPage.qml qml/AboutPage.qml dice-roller.desktop.in
	touch po/dice-roller.bhdouglass.pot
	xgettext --language=JavaScript --keyword=tr --keyword=tr:1,2 --add-comments=TRANSLATORS qml/Main.qml -o po/dice-roller.bhdouglass.pot
	xgettext --language=JavaScript --keyword=tr --keyword=tr:1,2 --add-comments=TRANSLATORS qml/DiceDialog.qml -o po/dice-roller.bhdouglass.pot
	xgettext --language=JavaScript --keyword=tr --keyword=tr:1,2 --add-comments=TRANSLATORS qml/MainPage.qml -o po/dice-roller.bhdouglass.pot
	xgettext --language=JavaScript --keyword=tr --keyword=tr:1,2 --add-comments=TRANSLATORS qml/AboutPage.qml -o po/dice-roller.bhdouglass.pot
